...
/**
 * Solution 5: Custom AIController that changes background color.
 */
@Route("solution5")
public class Solution5View extends VerticalLayout {

    public Solution5View(DataSource dataSource) {
        // LLM provider
        ...
        public List<LLMProvider.ToolSpec> getTools() {
            return List.of(new LLMProvider.ToolSpec() {
                ...
                public String execute(String arguments) {
                    try {
                        var node = com.vaadin.flow.internal.JacksonUtils
                                .readTree(arguments);
                        var color = node.get("color").asString();
                        view.getUI().ifPresent(ui -> ui.access(() -> view
